...
Source Database       : miniguangzhoudaguansi
...
-- ----------------------------
-- Table structure for `lr_case`
-- ----------------------------
DROP TABLE IF EXISTS `lr_case`;
...
-- ----------------------------
-- Table structure for `lr_consult`
-- ----------------------------
DROP TABLE IF EXISTS `lr_consult`;
CREATE TABLE `lr_consult` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1:咨询;2:服务',
  `addtime` varchar(255) DEFAULT NULL COMMENT '添加时间',
...
CREATE TABLE `lr_product` (
  ...
  `shop_name` varchar(255) DEFAULT NULL COMMENT '事务所',
  `service` varchar(255) DEFAULT NULL COMMENT '服务项目',
  `digest` text COMMENT '律师简介',
  `zyjy` text COMMENT '执业经验',
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '广州打官司网', '', '广州打官司网', '', 'Copyright © 2017', '', '020-0000000', '1505727165');
...
-- ----------------------------
INSERT INTO `lr_pro_cat` VALUES ('1', '0', '霹雳', null, '0', '0', '0', '1505789207');
...
CREATE TABLE `lr_user` (
  ...
  `shop_name` varchar(255) DEFAULT NULL COMMENT '事务所',
  `photo_ls` varchar(255) DEFAULT NULL COMMENT '头像',
  `dizhi` varchar(255) DEFAULT NULL COMMENT '地址',
  `service` varchar(255) DEFAULT NULL COMMENT '服务项目',
  `cz` varchar(255) DEFAULT NULL COMMENT '传真',
  `digest` text COMMENT '律师简介',
